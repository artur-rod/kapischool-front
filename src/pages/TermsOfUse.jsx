  ...
  return (
    <>
      ...
      <div className="w-75 container mt-4">
        <h2 className="text-center">Website Terms of Use</h2>

        <p>Version 1.0</p>

        <p>
          The KapiSchool website located at arturodrigues.xyz is a copyrighted
          work belonging to KapiSchool. Certain features of the Site may be
        ...
        <h2 className="text-center">Access to the Site</h2>
        ...
        <h2 className="text-center">Third-Party Links & Ads and Other Users</h2>
        ...
        <p>
          ...
          KapiSchool uses ‘cookies’. These cookies are used to store information
        ...
        <h2 className="text-center">Disclaimers</h2>
        ...
        <h2 className="text-center">Limitation on Liability</h2>
        ...
        <h2 className="text-center">Copyright Policy</h2>
        ...
        <p>
          ...
          the Company should be sent to: Street 1, 234 - Andradas, MG - Brasil.
        ...
        <p>Address: Street 1, 234 - Andradas, MG - Brasil</p>
        <p>Email: artur.rodrigues@linkapi.com.br</p>
      </div>
    </>
  );
};
